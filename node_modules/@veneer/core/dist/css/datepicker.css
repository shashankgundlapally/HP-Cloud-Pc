.vn-datepicker {
  ...
  .vn-datepicker__icon {
    ...
    right: 10px;
    top: 10px; }
  .vn-datepicker__button {
    left: 30%;
    margin-bottom: 15px; }
  .vn-datepicker__input {
    ...
    .vn-datepicker__input::-webkit-input-placeholder {
      color: #999999;
      font-style: normal !important; }
    .vn-datepicker__input:-moz-placeholder {
      color: #999999;
      font-style: normal !important; }
    .vn-datepicker__input::-moz-placeholder {
      color: #999999;
      font-style: normal !important; }
    .vn-datepicker__input:-ms-input-placeholder {
      color: #999999;
      font-style: normal !important; }
    .vn-datepicker__input:focus, .vn-datepicker__input:hover {
      border: 1px solid #0096d6; }
    .vn-datepicker__input:disabled {
      background-color: #ffffff;
      border: 1px solid #cccccc;
      color: #cccccc; }
      .vn-datepicker__input:disabled:focus, .vn-datepicker__input:disabled:hover {
        border-color: #cccccc;
        color: #cccccc; }
      .vn-datepicker__input:disabled::-webkit-input-placeholder {
        color: #cccccc; }
      .vn-datepicker__input:disabled:-moz-placeholder {
        color: #cccccc; }
      .vn-datepicker__input:disabled::-moz-placeholder {
        color: #cccccc; }
      .vn-datepicker__input:disabled:-ms-input-placeholder {
        color: #cccccc; }
    .vn-datepicker__input--error {
      border: 1px solid #f04c38; }
      .vn-datepicker__input--error:focus, .vn-datepicker__input--error:hover {
        border: 1px solid #f04c38; }
    .vn-datepicker__input--open {
...
.DayPickerKeyboardShortcuts__show--bottom-right {
  ...
  border-right: 33px solid #0096d6;
  bottom: 0;
  right: 0; }
...
.CalendarDay {
  ...
  .CalendarDay--outside {
    color: #cccccc; }
  .CalendarDay--hovered, .CalendarDay--selected, .CalendarDay--highlighted-calendar {
    -webkit-border-radius: 3px;
    -moz-border-radius: 3px;
    -ms-border-radius: 3px;
    border-radius: 3px; }
  ...
  .CalendarDay--hovered, .CalendarDay--selected {
